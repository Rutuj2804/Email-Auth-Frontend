    ...
    methods: {
        async reset() {
            ...
            try {
                ...
                const body = { password: this.password, confirmpassword: this.cpassword }

                const res = await axios.put(`http://localhost:5000/auth/verify/${this.id}`, body, config)
    ...
    <main>
        <div class="login__Wrapper">
            ...
            <form>
                ...
                <div class="login__InputDiv">
                    <input type="password" name="password" id="" required v-model="cpassword">
